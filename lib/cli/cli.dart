...
class UserCLI {
  ...
  UsersWebService _userWebService;
  ...
  UserCLI() {
    ...
    _security = false;
    _devMode = true;
    _userWebService = UsersWebService(_security, _devMode);
  }
  ...
  void optionCreateUser() async {
    ...
    try {
      ...
      var response = await _userWebService.createUser(_name, _email, _password);
  ...
  void optionUpdateUser() async {
    ...
    try {
      ...
      _password = prompts.get('name of a password: ', defaultsTo: _password);
      var response =
          await _userWebService.updateUser(_id, _name, _email, _password);
